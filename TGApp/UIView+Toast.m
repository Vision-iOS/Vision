...
- (CGPoint)cs_centerPointForPosition:(id)point withToast:(UIView *)toast {
    ...
    CGFloat bottomPadding = (style.verticalPadding + safeInsets.bottom)+100;
...
- (instancetype)initWithDefaultStyle {
    self = [super init];
    if (self) {
        self.backgroundColor = [TGColor dynamicToastBackgroundColor];
        self.titleColor = [TGColor dynamicToastTextColor];
        self.messageColor =  [TGColor dynamicToastTextColor];
